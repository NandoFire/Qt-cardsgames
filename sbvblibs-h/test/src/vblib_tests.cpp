...
//    strContainer.push_back(VBString("123"));
//    strContainer.push_back(VBString("123"));
//    strContainer.push_back(VBString("123"));
//    strContainer.push_back(VBString("123"));
//    strContainer.push_back(VBString("123"));
...
void VBFileDirectory_test_recursive(VBString path) {
    cout << "=== VBFileDirectory_test_recursive" << endl;
...
void VBFileDirectory_test() {
    cout << "=== VBFileDirectory_test" << endl;
...
int math_test() {
    ...
    VBAssert(nearEqual(r, 6.6, eps), "r");
    VBAssert(nearEqual(s, 2.44444444444444444, eps), "s");
    // cout << "s=" << s << endl;
    return 0;
}

void VBString_test_2() {
    cout << "=== VBString_test_2" << endl;
